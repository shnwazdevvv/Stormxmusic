...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAEC7t1pxm3imuRPhyV4naRWpdEoeGiYnAACaxkAAvE6kFTl1l-0QgABF6M6BA")
        ...
        try:
            ...
            await lols.edit_text("**⚡ѕтαятιиg.**")
            await lols.edit_text("**⚡ѕтαятιиg....**")
            m = await message.reply_sticker("CAACAgUAAxkBAAEC7t1pxm3imuRPhyV4naRWpdEoeGiYnAACaxkAAvE6kFTl1l-0QgABF6M6BA")
